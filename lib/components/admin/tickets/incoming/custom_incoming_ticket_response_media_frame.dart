...
class CustomIncomingTicketResponseMediaFrame extends StatefulWidget {
  final TicketModel data;
  CustomIncomingTicketResponseMediaFrame({@required this.data});

  @override
  _CustomIncomingTicketResponseMediaFrameState createState() =>
      _CustomIncomingTicketResponseMediaFrameState();
}

class _CustomIncomingTicketResponseMediaFrameState
    extends State<CustomIncomingTicketResponseMediaFrame> {
